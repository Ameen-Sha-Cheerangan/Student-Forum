  ...
  return (
    <div className='bg-[#191A21] min-h-screen' onClick={handleCloseSearch}>
      ...
      <div className='pt-20 w-[40%] md:mx-auto h-full mx-2 text-[#f6f7f9]' style={{ marginLeft: '26%' }}>
        <h1 className='mb-10 ml-30 text-5xl font-medium '>Create a Course</h1>
        <p className='mt-2 mb-2'>Select the Department</p>
        <Autocomplete
          focus={focusOne}
          refOne={refOne}
          topic={topic}
        ...
        <form className='flex flex-col gap-1' onSubmit={submitHandler}>
          ...
          <div className=' flex items-end '>
            <button className='bg-[#B6FFFA] text-[#191a20] mt-5 text-white  rounded-lg hover:opacity-90 px-3 py-2' style={{
              color: '#191a20'
            }}>
              Create Course
            </button>
